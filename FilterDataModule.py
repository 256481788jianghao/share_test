...
printTime(2)
#所有股票代码
all_share_codes = all_share_list.index
all_share_list['code_int'] = [int(x) for x in all_share_list.index]

all_share_list300 = dataBase.get_hs300_sharelist()
#print(all_share_list300)
